...
//
// Byte 48 (BL_ENABLE): 0xC5 (backdoor pin check enabled)
//   - 0xC5 = backdoor pin check enabled (DIO11 LOW enters bootloader)
//   - Restored to 0xC5 to allow UART bootloader flashing via cc2538-bsl
//   - Note: DIO11 must be held HIGH during normal boot (gpioset GPIO17=1)
//     otherwise floating LOW may cause bootloader entry
//
...
const uint8_t ccfg_data[88] = {
    ...
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xc5, 0x0b, 0xfe, 0xc5, 0xff, 0xff, 0xff, 0xff, 0xc5, 0xff, 0xff, 0xff,  // Byte 48: 0xC5 (backdoor enabled, DIO11 LOW enters bootloader)
